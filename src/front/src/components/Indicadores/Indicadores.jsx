...
const Indicadores = () => {
    ...
    useEffect(() => {
        fetch('http://3.144.215.154:8080/cliente/getQuantidadeClientesPorMes', {
            method: 'GET',
            headers: {
        ...
        fetch('http://3.144.215.154:8080/apointment/obterQuantidadeServicosPorFeedback', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            }
        ...
        fetch('http://3.144.215.154:8080/cupom/obterCuponsPorStatus', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            }
        ...
        fetch('http://3.144.215.154:8080/apointment/getQuantidadeServicosPorMes', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            }
